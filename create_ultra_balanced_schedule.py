#!/usr/bin/env python3
"""
Create an ultra-balanced PhD schedule with work distributed evenly throughout the timeline.
...
def create_ultra_balanced_schedule(input_file, output_file):
    """Create an ultra-balanced schedule with systematic redistribution."""
    ...
    # * Phase 1: Redistribute dissertation work across 8 quarters (2025-Q4 to 2027-Q2)
    dissertation_tasks = [t for t in tasks if t['Category'] == 'DISSERTATION']
    other_tasks = [t for t in tasks if t['Category'] != 'DISSERTATION']
    
    # Spread dissertation work evenly from 2025-Q4 to 2027-Q2
    ...
    print(f"Ultra-balanced schedule written to {output_file}")
...
if __name__ == "__main__":
    create_ultra_balanced_schedule(
