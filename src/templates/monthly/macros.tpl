...
\newcommand{\ColorLegend}{%
  ...
  \begin{center}%
    ...
    \hspace{1em}%
    \fcolorbox{black}{#4A90E2}{\makebox[0.8em][c]{\textcolor{white}{\tiny P}}}%
    \hspace{0.3em}\tiny Proposal%
    \hspace{0.8em}%
    \fcolorbox{black}{#F5A623}{\makebox[0.8em][c]{\textcolor{white}{\tiny L}}}%
    \hspace{0.3em}\tiny Laser%
    \hspace{0.8em}%
    \fcolorbox{black}{#7ED321}{\makebox[0.8em][c]{\textcolor{white}{\tiny I}}}%
    \hspace{0.3em}\tiny Imaging%
    \hspace{0.8em}%
    \fcolorbox{black}{#BD10E0}{\makebox[0.8em][c]{\textcolor{white}{\tiny A}}}%
    \hspace{0.3em}\tiny Admin%
    \hspace{0.8em}%
    \fcolorbox{black}{#D0021B}{\makebox[0.8em][c]{\textcolor{white}{\tiny D}}}%
    \hspace{0.3em}\tiny Dissertation%
    \hspace{0.8em}%
    \fcolorbox{black}{#50E3C2}{\makebox[0.8em][c]{\textcolor{white}{\tiny R}}}%
    \hspace{0.3em}\tiny Research%
    \hspace{0.8em}%
    \fcolorbox{black}{#B8E986}{\makebox[0.8em][c]{\textcolor{white}{\tiny P}}}%
