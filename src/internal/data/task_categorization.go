...
func (tcm *TaskCategoryManager) GetCategoryColor(categoryName string) (string, bool) {
	category, exists := tcm.categories[categoryName]
	if !exists {
		return "", false
	}
...
func (tcm *TaskCategoryManager) GetCategoryDescription(categoryName string) (string, bool) {
	category, exists := tcm.categories[categoryName]
	if !exists {
		return "", false
	}
	return category.Description, true
}
