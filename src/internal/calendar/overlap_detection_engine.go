...
func (od *OverlapDetector) DetectOverlaps(tasks []*shared.Task) *OverlapAnalysis {
...
func (od *OverlapDetector) groupOverlappingTasks(tasks []*shared.Task) []*TaskGroup {
...
func (od *OverlapDetector) tasksOverlap(group *TaskGroup, task *shared.Task) bool {
...
func (od *OverlapDetector) tasksOverlapDirect(task1, task2 *shared.Task) bool {
...
func (od *OverlapDetector) detectGroupOverlaps(tasks []*shared.Task) []*TaskOverlap {
...
func (od *OverlapDetector) analyzeTaskOverlap(task1, task2 *shared.Task) *TaskOverlap {
...
func (od *OverlapDetector) determineOverlapType(task1, task2 *shared.Task, overlapStart, overlapEnd time.Time) OverlapType {
...
func (od *OverlapDetector) calculateOverlapSeverity(task1, task2 *shared.Task, overlapType OverlapType, duration time.Duration) OverlapSeverity {
...
func (od *OverlapDetector) calculateOverlapPercentage(task1, task2 *shared.Task, overlapDuration time.Duration) float64 {
...
func (od *OverlapDetector) calculateOverlapPriority(task1, task2 *shared.Task) int {
...
func (od *OverlapDetector) generateConflictInfo(task1, task2 *shared.Task, overlapType OverlapType, severity OverlapSeverity) (string, string) {
