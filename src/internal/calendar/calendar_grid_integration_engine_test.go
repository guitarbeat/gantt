...
func TestCalendarGridIntegration(t *testing.T) {
	...
	if integration.stackingEngine == nil {
		t.Error("Expected stacking engine to be initialized")
	}
...
func TestCalendarGridIntegrationCalculateTaskHeight(t *testing.T) {
	...
	height := integration.calculateTaskHeight(&shared.Task{}, 0.5)
	...
	highWeightHeight := integration.calculateTaskHeight(&shared.Task{}, 1.0)
