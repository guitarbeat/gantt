...
func NewStackingEngine(overlapDetector *OverlapDetector, conflictCategorizer *ConflictCategorizer, priorityRanker *PriorityRanker) *StackingEngine {
...
func (se *StackingEngine) StackTasks(tasks []*shared.Task, context *StackingContext) *StackingResult {
	...
	overlapAnalysis := se.overlapDetector.DetectOverlaps(tasks)
